        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                AgentConversationView(
                    ...
                    controlledEvalRuns: store.controlledEvalRuns,
                    controlledEvalRestoreFailure: store.controlledEvalRestoreFailure,
                    ...
                    onReviewProductionReadiness: store.reviewProductionReadiness,
                    productionReadinessReviewEligibility: store.productionReadinessReviewEligibility,
                    aiEvalPlanReviewEligibility: store.aiEvalPlanReviewEligibility,
                    onReviewReadinessReport: store.reviewReadinessReport,
                    onReviewAIEvalPlan: store.reviewAIEvalPlan,
                    onPrepareControlledEvalExecution: store.prepareControlledEvalExecution,
                    controlledEvalExecutionReviewEligibility: store.controlledEvalExecutionReviewEligibility,
                    onConfirmControlledEvalExecution: store.confirmControlledEvalExecution,
                    onConfirmAuthorizedControlledEvalExecution: store.confirmAuthorizedControlledEvalExecution,
                    onPrepareControlledEvalResultReview: store.prepareControlledEvalResultReview,
                    evalResultsReviewEligibility: store.evalResultsReviewEligibility,
                    onReviewEvalResults: store.reviewEvalResults,
